...
'*************************************************************************************************
'* fSample - fSelfSub based sample that demonstrates an alternate callback object
'*
...
Private Sub Form_Load()
  ...
  sc_Subclass Me.hwnd, , , frm
  sc_AddMsg Me.hwnd, ALL_MESSAGES, MSG_BEFORE_AFTER
End Sub
