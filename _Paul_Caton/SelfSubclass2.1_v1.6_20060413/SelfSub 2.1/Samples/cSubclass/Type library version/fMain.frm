...
'*
'* Note: this project uses the WinSubHook3 type library to define the callback interface. If you
'*  wish, you can instead use iSubclass.cls as provided in the PSC submission. Simply remove the
'*  type library reference and add iSubclass.cls to this project. No other changes are required.
'*
