...
Begin VB.UserControl uSelfSub 
   ...
   ScaleWidth      =   226
End
Attribute VB_Name = "uSelfSub"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
'*************************************************************************************************
'* uSelfSub - self-subclassing UserControl template
'*
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
  If Ambient.UserMode Then                                                  'If running, not designing
    'sc_Subclass UserControl.hwnd                                            'Subclass a window... or three
    'sc_AddMsg UserControl.hWnd, ALL_MESSAGES, MSG_BEFORE_AFTER              'Add messages of interest
  End If
End Sub
...
'*************************************************************************************************
  Debug.Print IIf(bBefore, "Before", "After"), _
              "&H" & Hex$(lng_hWnd), _
              "&H" & Hex$(uMsg), _
              "&H" & Hex$(wParam), _
              "&H" & Hex$(lParam), _
