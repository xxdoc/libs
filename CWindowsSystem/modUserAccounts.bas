...
'entry while the result is NERR_Success
           ...
           If ignoreBuiltIn = True Then
                ...
                Next
           End If
           If Not skipIt Then UserNames.Add Users(lElement).Name
...
If lptrStrBuffer Then Call NetApiBufferFree(lptrStrBuffer)
End Function
