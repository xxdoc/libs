...
Begin VB.Form frmServiceControl 
   ...
   Begin VB.Label lblDisclaimer 
      Alignment       =   2  'Center
      Caption         =   "Copyright © 2000-2004 Sergey Merzlikin"
      ForeColor       =   &H00000000&
      Height          =   225
      Left            =   240
      TabIndex        =   0
...
Private Sub Form_Load()
    If Not CheckIsNT() Then
        MsgBox "This program requires Windows NT/2000/XP/2003"
        Unload Me
        Exit Sub
    End If
    AppPath = App.Path
...
Private Sub lblEmail_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button = 1 Then
        ShellExecute Me.hWnd, StrPtr("open"), StrPtr("mailto:" & lblEmail.Caption), 0&, StrPtr(App.Path), SW_SHOWNORMAL
    End If
End Sub
...
Private Sub lblWeb_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button = 1 Then
        ShellExecute Me.hWnd, StrPtr("open"), StrPtr(lblWeb.Caption), 0&, StrPtr(App.Path), SW_SHOWNORMAL
    End If
End Sub
