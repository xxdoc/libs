...
Private Sub Form_Load()
  sc_Subclass Me.hwnd, , 1                        'Subclass the form to callback ordinal #1 (default), the final private routine
  sc_AddMsg Me.hwnd, ALL_MESSAGES, MSG_BEFORE
  
  sc_Subclass Picture1.hwnd, , 2                  'Subclass the PictureBox to callback ordinal #2, the second last private routine
  sc_AddMsg Picture1.hwnd, ALL_MESSAGES, MSG_AFTER
  
  Show
  DoEvents
  MsgBox "Messages shown in the immediate pane", vbInformation
End Sub
...
'*****
'* PictureBox callback, ordinal #2, the second last method
'*****
Private Sub zWndProc2(ByVal bBefore As Boolean, _
...
'*************************************************************************************************
  Debug.Print "Picture1: " & _
              ...
              "&H" & Hex$(lParam), _
              "&H" & Hex$(lParamUser), _
              IIf(bBefore, vbNullString, "&H" & Hex$(lReturn))
End Sub

'*****
'* Form callback, ordinal #1, the last method
'*****
