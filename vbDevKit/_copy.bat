copy vbdevkit.dll D:\_code\iDef\SysAnalyzer\dependancy\
copy vbdevkit.dll D:\_code\iDef\COMRaider\dependancy\
copy vbdevkit.dll D:\_code\iDef\IDACompare\dependancy\
copy vbdevkit.dll D:\_code\iDef\MAP\dependancies\
