...
Sub HookWb(oWb As WebBrowser, Optional frm As Form)
...
Private Sub IDropSource_GiveFeedback(ByVal dwEffect As olelib.DROPEFFECTS)
    Err.Raise E_NOTIMPL
End Sub

Private Sub IDropSource_QueryContinueDrag(ByVal fEscapePressed As olelib.BOOL, ByVal grfKeyState As Long)
    Err.Raise E_NOTIMPL
End Sub
