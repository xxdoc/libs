...
namespace NWin32
{
    public class Win32
    {
        ...
        public static bool WriteProcessLong(IntPtr hProc, int address, long value)
        {
            int bytesWritten;
            byte[] val = BitConverter.GetBytes(value);
            bool worked = WriteProcessMemory(hProc, (IntPtr)address, val, val.Length, out bytesWritten);
            return worked;
        }
