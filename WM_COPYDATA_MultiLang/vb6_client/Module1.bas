...
Private Sub RecieveTextMessage(lParam As Long)
    ...
    If CopyData.dwFlag = 3 Then
        ...
        Form1.List2.AddItem "Raw Recv(" & Temp & ")"
        ResponseBuffer = Temp
    End If
...
Sub SendCMD(msg As String)
    ...
    Form1.List2.AddItem "SendingCMD(hwnd=" & Server_Hwnd & ", msg=" & msg & ")"
    
    Call CopyMemory(buf(1), ByVal msg, Len(msg))
    cds.dwFlag = 3
    cds.cbSize = Len(msg) + 1
    cds.lpData = VarPtr(buf(1))
    i = SendMessage(Server_Hwnd, WM_COPYDATA, gHW, cds)
