...
Begin VB.Form frmTest 
   ...
   Begin VB.ComboBox cboTabAppearance 
      ...
      EndProperty
      Height          =   330
      ItemData        =   "frmTest.frx":014E
      Left            =   8940
      List            =   "frmTest.frx":0150
      Style           =   2  'Dropdown List
      TabIndex        =   36
      Top             =   1224
      Width           =   2712
   ...
   Begin TabExCtl.SSTabEx SSTabEx1 
      ...
      TabPic16(1)     =   "frmTest.frx":10CC
      TabPic20(1)     =   "frmTest.frx":141E
      TabPic24(1)     =   "frmTest.frx":1920
      TabCaption(1)   =   "Frame"
      Tab(1).ControlCount=   1
      Tab(1).Control(0)=   "Frame1"
      TabPic16(2)     =   "frmTest.frx":2032
      TabPic20(2)     =   "frmTest.frx":2384
      TabPic24(2)     =   "frmTest.frx":2886
      TabCaption(2)   =   "Other"
      Tab(2).ControlCount=   1
      Tab(2).Control(0)=   "Picture1"
      TabPic16(3)     =   "frmTest.frx":2F98
      TabPic20(3)     =   "frmTest.frx":32EA
      TabPic24(3)     =   "frmTest.frx":37EC
      TabCaption(3)   =   "Cmd"
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.ComboBox Combo1 
            Height          =   300
            ItemData        =   "frmTest.frx":3EFE
            Left            =   396
            List            =   "frmTest.frx":3F0B
            TabIndex        =   7
            Text            =   "1234567890"
            Top             =   648
            Width           =   1164
...
Private Sub chkTabHoverHighlight_Click()
    SSTabEx1.TabHoverHighlight = chkTabHoverHighlight.Value = 1
End Sub
...
Private Sub cmdChangeForeColor_Click()
    ...
    If Not iDlg.Cancelled Then
        ...
        Option1.ForeColor = SSTabEx1.ForeColor
        Option2.ForeColor = SSTabEx1.ForeColor
        Check1.ForeColor = SSTabEx1.ForeColor
        Label1.ForeColor = SSTabEx1.ForeColor
        Label22.ForeColor = SSTabEx1.ForeColor
        Option3.ForeColor = SSTabEx1.ForeColor
        Option4.ForeColor = SSTabEx1.ForeColor
        Check2.ForeColor = SSTabEx1.ForeColor
    End If
End Sub
